...
-- Copiando dados para a tabela zetta.users: ~0 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `role_id`, `username`, `name`, `email`, `avatar`, `gender`, `birthday`, `bio`, `status`, `confirmed_email`, `active`, `token`, `token_date`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 1, 'admin', 'Admin', 'admin@z.com', './public/img/thumb-boy.svg', 2, '1992-08-30', NULL, 2, 1, 1, NULL, NULL, '2018-01-01 00:00:01', '2018-01-01 00:00:01', NULL);
